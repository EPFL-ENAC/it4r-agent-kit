...
Read **`AGENTS.md`** at the root of this kit (`${CLAUDE_PLUGIN_ROOT}/AGENTS.md`
under a plugin install) — it is the whole ruleset. Apply it to whatever you are
...
The `plan-conventions` skill covers how issues, plans, and ADRs are filed.
